...
public class CircleTimeView extends View {
    ...
    private LapDataProvider mLapLabelDataProvider = currentTimeInSeconds -> String.valueOf(getHoursFromSeconds(mCurrentTimeInSeconds));
    // endregion
    ...
    public static long getTimeLapDeltaByTimeFormat(@TimeFormat int timeFormat) {
        return timeFormat == FORMAT_MINUTES_HOURS ? SECONDS_IN_HOUR : SECONDS_IN_MINUTE;
    }
    ...
    public static long getTimeSecondsCoefficient(@TimeFormat int timeFormat) {
        return timeFormat == FORMAT_MINUTES_HOURS ? SECONDS_IN_MINUTE : 1;
    }
