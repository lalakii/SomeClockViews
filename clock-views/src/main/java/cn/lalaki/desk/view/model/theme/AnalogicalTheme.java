...
import cn.lalaki.desk.view.enumeration.analogical.DegreeType;
import cn.lalaki.desk.view.enumeration.analogical.DegreesStep;
import cn.lalaki.desk.view.enumeration.analogical.ValueDisposition;
import cn.lalaki.desk.view.enumeration.analogical.ValueStep;
import cn.lalaki.desk.view.enumeration.analogical.ValueType;
...
public class AnalogicalTheme {
    ...
    private final int centerInnerColor;
    private final int centerOuterColor;
    private final boolean showBorder;
    private final int borderColor;
    private final boolean showSecondsNeedle;
    private final int needleHoursColor;
    private final int needleMinutesColor;
    private final int needleSecondsColor;
    private final boolean showProgress;
    private final int progressColor;
    private final boolean showMinutesProgress;
    private final int minutesProgressColor;
    private final float minutesProgressFactor;
    private final boolean showSecondsProgress;
    private final int secondsProgressColor;
    private final float secondsProgressFactor;
    private final boolean showDegrees;
    private final int degreesColor;
    private final DegreeType degreesType;
    private final DegreesStep degreesStep;
    private final int valuesFont;
    private final int valuesColor;
    private final boolean showHoursValues;
    private final boolean showMinutesValues;
    private final float minutesValuesFactor;
    private final ValueStep valueStep;
    private final ValueType valueType;
    private final ValueDisposition valueDisposition;
